<?php include 'header/header.php';?>
      ...
      <a class="navbar-brand mr-1" href="/">Bem vindo <?php echo $this->session->username; ?></a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="/form/lista">Listar</a>
            <a class="dropdown-item" href="/form/cadastro">Cadastrar</a>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="/cliente/lista">Listar</a>
