                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="/form/cadastro">Cadastro</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/ListaCadastro">Listagem</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-code fa-fw"></i> Java Script<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/animais-fantasticos">Animais Fantasticos</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="pages/panels-wells.twig">Panels and Wells</a>
                            </li>
                            <li>
                                <a href="pages/buttons.twig">Buttons</a>
                            </li>
                            <li>
                                <a href="pages/notifications.twig">Notifications</a>
                            </li>
                            <li>
                                <a href="pages/typography.twig">Typography</a>
                            </li>
                            <li>
                                <a href="pages/icons.twig"> Icons</a>
                            </li>
                            <li>
                                <a href="pages/grid.twig">Grid</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
